...
const Footer = () => {
  ...
  <nav>
    ...
    <Link to='/availableFood'> <a className="link link-hover hover:text-yellow-500">Available Foods</a> </Link>
    <Link to='/addFood'><a className="link link-hover hover:text-yellow-500">Add Food</a> </Link>
   <Link to='/manageFood'> <a className="link link-hover hover:text-yellow-500">Manage My Foods</a> </Link> 
    <Link to='/foodReq'><a className="link link-hover hover:text-yellow-500">My Food Request</a></Link>
  </nav> 
  <nav>
  ...
  <aside className="items-center ">
    ...
    <img className=" lg:w-[40px] lg:h-[40px] w-10 h-10 ml-24 " src="https://i.ibb.co/TrTMhFd/logo.png" alt="" /> 

    <h1 className="flex-1 px-2 mx-2 text-xl font-semibold "><span className="text-yellow-400 ">FoodShare</span> Network</h1>
  </aside>
